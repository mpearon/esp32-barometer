...
stepperMotor tempStepper = stepperMotor( "temperature", 0, 0, 0, 1302, false, 2048, 26, 33, 25, 32 );
stepperMotor humidStepper = stepperMotor( "humidity", 0, 0, 0, 1113, true, 2048, 13, 14, 12, 27 );
